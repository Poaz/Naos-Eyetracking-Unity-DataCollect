...
using UnityEngine;
    ...
    public int Predict()
    {
        ...
        myProcessStartInfo.Arguments = pythonScript + " " + tensor[0] + " " + tensor[1] + " " + tensor[2] + " " + tensor[3]
            ...
            UnityEngine.Debug.Log("Calling Python script with arguments:" + " " + tensor[0] + " " + tensor[1] + " " + tensor[2] + " " + tensor[3]
                                           + " " + tensor[4] + " " + tensor[5] + " " + tensor[6] + " " + tensor[7] + " " + tensor[8]
                                           + " " + tensor[9]);
